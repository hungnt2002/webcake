        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <h2 class="noo-sh-title-top">
              We are <span> Nhóm 9 CakeShop</span>
            </h2>
            <p>
              "Tại NamCakaShop, chúng tôi luôn hiểu rằng những chiếc bánh mới ra
              lò là những chiếc bánh ngon nhất. Chúng tôi đặc biệt chọn lọc
              những nguyên liệu tốt cho sức khỏe cũng như chú trọng sự tươi mới
              của từng sản phẩm khi đến tay khách hàng.Sự hài lòng của khách
              hàng chính là niềm vui của gia đình Nhóm 9 CakeShop"
            </p>
          </div>
        </div>
        <div class="row my-5">
            ...
            <div class="hover-team">
              ...
              <div class="team-description">
                <p>
                  ...
                  Hiểu biết: Jsp/Servlet, CSS, HTML, JS, MySQL, SQL Server<br />
                  Công cụ: VS Code, GitHub<br />
