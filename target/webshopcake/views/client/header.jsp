    ...
    <div class="row">
      <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
        <div class="our-link">
          <ul>
            <li>
              <a href="#"><i class="fas fa-phone"></i>Hotline: 0868014219 </a>
            </li>
          </ul>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand"
          ><img src="template/client/images/logoshop.jpg" class="logo" alt=""
        /></a>
      </div>
      ...
      <div class="collapse navbar-collapse" id="navbar-menu">
        ...
        >
          ...
          <li class="nav-item">
            <a
              class="nav-link"
              href="${pageContext.request.contextPath }/chungtoi"
              >Chúng tôi</a
            >
          </li>
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li>
                <a
                  href="${pageContext.request.contextPath }/category?categoryId=1"
                  >Bánh ngọt</a
                >
              </li>
              <li>
                <a
                  href="${pageContext.request.contextPath }/category?categoryId=2"
                  >Bánh mặn</a
                >
              </li>
              <li>
                <a
                  href="${pageContext.request.contextPath }/category?categoryId=3"
                  >Bánh trái cây</a
                >
              </li>
              <li>
                <a
                  href="${pageContext.request.contextPath }/category?categoryId=4"
                  >Bánh kem</a
                >
              </li>
              <li>
                <a
                  href="${pageContext.request.contextPath }/category?categoryId=5"
                  >Bánh pizza</a
                >
              </li>
              <li>
                <a
                  href="${pageContext.request.contextPath }/category?categoryId=6"
                  >Bánh Crepe</a
                >
              </li>
            </ul>
        ...
        <ul class="cart-list">
          <c:forEach var="cart1" items="${cart}">
            <li>
              <a href="#" class="photo"
                ><img
                  src="template/client/images/${cart1.value.cake.thumbnail }"
                  class="cart-thumb"
                  alt=""
              /></a>
              <h6>
              ...
              <p>
                ${cart1.value.quantity }x -
                <span class="price">${cart1.value.cake.currencyPrice }</span>
              </p>
            </li>
            <c:set
              var="totalPrice"
