                  ...
                  <div class="mb-4">
                    ...
                    <div class="custom-control custom-radio">
                      ...
                      <label class="custom-control-label" for="shippingOption2"
                        >Giao nhanh như thỏ</label
                      >
                      <span class="float-right font-weight-bold">20.000đ</span>
                    </div>
                    ...
                    <div class="custom-control custom-radio">
                      ...
                      <label class="custom-control-label" for="shippingOption3"
                        >Giao nhanh như flash</label
                      >
                      <span class="float-right font-weight-bold">50.00đ</span>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <div class="rounded p-2 bg-light">
                      <div class="media mb-2 border-bottom">
                        <div class="media-body">
                          <a href="detail.html">
                            ${cart1.value.cake.cakeName }</a
                          >
                          <div class="small text-muted">
                            Price: ${cart1.value.cake.currencyPrice }
                            <span class="mx-2">|</span>
                            Qty:${cart1.value.quantity}
                            <span class="mx-2">|</span> Subtotal:
                            ${cart1.value.currencyPrice }
                          </div>
                        </div>
                      </div>
                    </div>
